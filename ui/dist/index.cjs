...
var stylex = __toESM(require("@stylexjs/stylex"), 1);
var DARK = "@media (prefers-color-scheme: dark)";
var colors = stylex.defineVars({
...
var paddingRight = stylex.create({
  small: {
...
var paddingBottom = stylex.create({
  small: {
...
var marginBottom = stylex.create({
  small: {
